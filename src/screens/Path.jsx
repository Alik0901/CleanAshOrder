/*  Path.jsx – The Path Begins  ___________________________________________ */
...
/* номер → картинка в /public/fragments */
const FRAG_IMG = {
...
export default function Path(){
    ...
    try{
      ...
      if(j.paid){
        ...
        if(j.cursed){
          ...
          setFrag(`/fragments/${FRAG_IMG[j.newFragment]??FRAG_IMG[1]}`);
          setTimeout(()=>setFrag(''),2300);
  ...
  return(
    <>
      ...
      {/* fragment animation */}
      {frag && <img src={frag} alt="fragment" style={S.frag}/>}
